  ...
  return (
    <div name="About" className=' flex flex-col  pt-[4%] md:pt-[3%] pb-[2%]   text-white' >
     <div className=' space-y-[2vh] ml-[3vw]'>
      ...
      <p className='text-[9px] sm:text-[2vw]  md:text-[1.8vw] xl:text-[1.5vw] '>I am Suraj Kumar Saw from Hazaribagh!</p>
     </div>
     <div className='text-[6px] sm:text-[1.9vw]  md:text-[1.7vw] xl:text-[1.2vw]  space-y-[2vh] mt-[2vh]'>
      ...
      <div className='px-[2vw]'>
        <h2 className='text-[9px] sm:text-[2vw]  md:text-[1.8vw] xl:text-[1.5vw] font-bold'>Matriculation</h2>
       <div className='px-[2vw]'>
      ...
      <div className='px-[2vw]'>
        <h2 className='text-[9px] sm:text-[2vw]  md:text-[1.8vw] xl:text-[1.5vw] font-bold '>Intermediate</h2>
       <div className='px-[2vw]'>
       <table className='border-1 border-red-900  '>
      ...
      <div className='px-[2vw]' >
        <h2 className='text-[9px] sm:text-[2vw]  md:text-[1.8vw] xl:text-[1.5vw] font-bold'>Graduation</h2>
        <p className='text-[6px] sm:text-[1.9vw]  md:text-[1.7vw] xl:text-[1.2vw]'>From Markham College of commerce Under Vinoba Bhave University  Hazibagh</p>
      </div>
     </div>
    </div>
  )
